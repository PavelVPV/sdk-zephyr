 ...
 * @ref bt_buf_get_rx function.
 *
 * @warning This callback must only be used for very short non-blocking operation (e.g. submitting a
 * work item).
 *
 * @param type A bit mask of buffer types that have been freed.
 */
