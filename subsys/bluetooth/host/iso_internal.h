...
/** A callback used to notify about free buffer in the iso rx pool. */
typedef void (*bt_iso_rx_ready_cb_t)(void);

/** Set a callback to notify about free buffer in the iso rx pool.
 *
 * @param cb Callback to notify about free buffer in the iso rx pool. If NULL, the callback is
 *           disabled.
 */
